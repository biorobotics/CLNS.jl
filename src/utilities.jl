...
function splice!(tour::Tour, i::Int64, cost::Float64)
  ...
  # tour.cost = tour.cost - tour.cost_seq[prev_i] - tour.cost_seq[i] + cost # Results in NaN when we have infinite costs
...
function insert!(tour::Tour, i::Int64, point::Vector{Float64}, set::Int64, pre_cost::Float64, post_cost::Float64)
  prev_i = prev_tour(tour, i)
  # tour.cost = tour.cost - tour.cost_seq[prev_i] + pre_cost + post_cost # Results in NaN when we have infinite costs
